...
export default function ApplicationPage() {
  ...
  function continueApplication() {
    const invalid = formRef.current?.querySelector(".application-step :invalid") as HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement | null;
    if (invalid) {
          ...
          {submitted ? (
            ...
            <>
              <div className="application-form-heading">
                <div><span>Formal Partnership Application</span><small>Fields marked * are required</small></div>
              ...
              <form ref={formRef} onSubmit={submitApplication}>
                {step === 1 && (
                  <section className="application-step" aria-labelledby="step-one-title">
                    ...
                    <label>Riding group name *<input required name="group_name" placeholder="Official group name" /></label>
                    <div className="field-row">
                      <label>Your role *
                  ...
                  <section className="application-step" aria-labelledby="step-two-title">
                    ...
                    <fieldset className="application-fieldset">
                      ...
                      <div className="application-choice-grid">
                        <label><input required type="radio" name="application_program" value="Member Preferred Pricing" /><span><b>01</b> Member Preferred Pricing</span></label>
                    ...
                    <div className="field-row">
                      <label>Primary riding focus *
                        <select required name="riding_focus" defaultValue="">
                      ...
                      <label>Organized events per year *
                        <select required name="annual_events" defaultValue="">
                          <option value="" disabled>Select range</option>
                    ...
                    <label>What would make this partnership valuable to your group? *
                      <textarea required name="partnership_goals" rows={4} placeholder="Tell us about your members, goals, events and priorities." />
                    </label>
                  </section>
                )}
                ...
                {step === 3 && (
                  <section className="application-step" aria-labelledby="step-three-title">
                    ...
                    <label className="upload-field">Completed member roster *
                      ...
                      <input required type="file" name="member_roster" accept=".xlsx,.xls,.csv" />
                    </label>
                    ...
                    <label className="consent application-consent"><input required type="checkbox" name="authority_confirmed" /><span>I confirm that I am authorized to submit this application on behalf of the riding group.</span></label>
                    <label className="consent application-consent"><input required type="checkbox" name="member_consent_confirmed" /><span>I confirm that members included in the roster have authorized the group to share their information with EVP for partnership administration, benefits, product fitment and optional swag fulfillment.</span></label>
                  </section>
                )}
